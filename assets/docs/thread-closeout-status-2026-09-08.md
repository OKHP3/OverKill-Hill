...
`6110ff85`. PR98 makes AI-reviewed locale release explicit; native certification
...
1. **A20 human acceptance:** execute the original Safari VoiceOver, NVDA, and
