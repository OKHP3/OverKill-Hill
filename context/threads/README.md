...
| [`overkill-hill-notion-manifesto-visual-crosswalk.md`](overkill-hill-notion-manifesto-visual-crosswalk.md) | Notion workspace search, selected page fetches, Extracts data-source searches, and local repository inspection | Manifesto, MurderBird, P3, publication, Replit, and GitHub provenance crosswalk with evidence tiers, captured directives, deliverables, and next actions. | redacted |
