#!/usr/bin/env python3
"""Plan en-US source artifacts and es-MX targets without writing files."""
...
VALIDATOR_PATH = Path(__file__).with_name("validate-en-us-to-es-mx.py")
VALIDATOR_SPEC = importlib.util.spec_from_file_location("validate_en_us_to_es_mx", VALIDATOR_PATH)
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if args.format == "json":
        ...
        if output["passed"]:
            ...
            print(f"Missing es-MX targets: {missing}")
        else:
