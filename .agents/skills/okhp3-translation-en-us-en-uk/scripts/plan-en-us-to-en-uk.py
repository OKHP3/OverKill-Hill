#!/usr/bin/env python3
"""Plan en-US source artifacts and en-GB targets without writing files."""
...
VALIDATOR_PATH = Path(__file__).with_name("validate-en-us-to-en-uk.py")
VALIDATOR_SPEC = importlib.util.spec_from_file_location("validate_en_us_to_en_uk", VALIDATOR_PATH)
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if args.format == "json":
        ...
        if output["passed"]:
            ...
            print(f"Missing en-GB targets: {missing}")
        else:
