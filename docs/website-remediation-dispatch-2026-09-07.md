...
| --- | --- | --- | --- | --- |
| A03 | A03 Restore content when scripts fail | `01a07aaf-0dfd-7e83-911b-710fe5f1ef0c` | `$HOME/.codex/worktrees/3d31/OverKill-Hill` | `codex/a03-fail-open-reveal` |
...
| A05 | A05 Make Skillz installation reproducible | `01a07aaf-0dfd-7e83-911b-70ec8de457e1` | `$HOME/.codex/worktrees/a529/OverKill-Hill` | `codex/a05-skillz-install` |
| A06 | A06 Correct project claims and concept labels | `01a07aaf-0dfd-7e83-911b-70cbac70080a` | `$HOME/.codex/worktrees/862f/OverKill-Hill` | `codex/a06-content-truth` |
| A07 | A07 Fix release retries and freshness gates | `01a07aaf-0e55-7e51-9720-3a8e5ad36deb` | `$HOME/.codex/worktrees/a694/OverKill-Hill` | `codex/a07-release-retry-freshness` |
| A08 | A08 Update the supported QA runtime | `01a07aaf-5674-7bc3-b036-6968cb60db9b` | `$HOME/.codex/worktrees/4bf9/OverKill-Hill` | `codex/a08-supported-qa-runtime` |
| A09 | A09 Fix macOS review fixture portability | `01a07aaf-58b6-7fb1-b286-2876960fdba5` | `$HOME/.codex/worktrees/3bf5/OverKill-Hill` | `codex/a09-review-fixture-portability` |
| A10 | A10 Cover all released pages in browser QA | `01a07aaf-5ba9-7d53-940f-84bfb3b54667` | `$HOME/.codex/worktrees/9108/OverKill-Hill` | `codex/remediation-a10` |
| A11 | A11 Unify project maturity and evidence | `01a07aaf-5ba9-7d53-940f-8490678d2bcd` | `$HOME/.codex/worktrees/177d/OverKill-Hill` | `codex/remediation-a11-status-registry` |
...
| A14 | A14 Improve phone hierarchy and spacing | `01a07aaf-5f84-7e00-8322-2de95f2e05fd` | `$HOME/.codex/worktrees/a1a8/OverKill-Hill` | `codex/a14-phone-proposals` |
| A15 | A15 Improve reading and contact journeys | `01a07aaf-662f-7321-a2df-5fc96ec56fae` | `$HOME/.codex/worktrees/6a75/OverKill-Hill` | `codex/a15-reader-orientation` |
| A16 | A16 Measure and improve transfer costs | `01a07aaf-6a21-74b1-a0dc-3b88375b1212` | `$HOME/.codex/worktrees/d191/OverKill-Hill` | `codex/a16-measured-economics` |
...
| A18 | A18 Harden preview serving and publication | `01a07aaf-7155-7460-a693-eb4f4cb66f87` | `$HOME/.codex/worktrees/b3e3/OverKill-Hill` | `codex/a18-preview-exposure` |
| A19 | A19 Evaluate response-header hosting options | `01a07aaf-73f5-7830-a79b-c84f52a17f9f` | `$HOME/.codex/worktrees/a8c6/OverKill-Hill` | `codex/a19-header-host-strategy` |
| A20 | A20 Independently verify visitor accessibility | `01a07aaf-7618-7fa1-8a56-226f7cc702a3` | `$HOME/.codex/worktrees/0a49/OverKill-Hill` | `codex/a20-independent-acceptance` |
